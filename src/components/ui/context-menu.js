...
const ContextMenuCheckboxItem = React.forwardRef(({ className, children, checked = "unchecked", ...props }, ref) => (_jsxs(ContextMenuPrimitive.CheckboxItem, { ref: ref, checked: typeof checked === "boolean"
        ? checked
