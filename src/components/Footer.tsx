      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col md:items-start bg-seagreen/20 p-4 rounded-md backdrop-blur-sm">
            ...
            <div className="hidden md:flex gap-4 mb-4 justify-center md:justify-start">
              <a
            ...
            {/* Mobile-only copyright notice at the bottom */}
            <div className="text-xs text-white/70 mt-5 text-center w-full md:hidden">
              <span className="text-xs align-text-top mr-1">©</span> 2025
              GCRFP. Alle Rechte vorbehalten.
            </div>
          </div>
