  ...
  return (
    <footer className="w-full bg-seagreen text-white">
      <div className="container mx-auto px-4 py-6">
        <div className="max-w-5xl mx-auto md:grid md:grid-cols-3 md:gap-6">
          {/* Logo Column */}
          <div className="flex flex-col items-center md:items-start">
            {/* Logo Box */}
            <div className="bg-white p-4 rounded-xl inline-block mb-3 w-full md:w-auto">
            ...
            <div className="hidden md:flex gap-4 mt-4 justify-start">
              {[
                { 
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="space-y-2 text-sm md:text-left text-center w-full bg-seagreen/20 p-3 rounded-xl backdrop-blur-sm">
          ...
          {/* Legal Links Column */}
          <div className="flex flex-col items-center md:items-start">
            <div className="bg-seagreen/20 p-3 rounded-xl backdrop-blur-sm w-full">
              <ul className="flex flex-col space-y-1 items-center md:items-start">
                <li>
                  <Link
                    to="/impressum"
              ...
              <div className="text-xs text-white/70 mt-3 text-center md:text-left hidden md:block">
                <span className="text-xs align-text-top mr-1">©</span> 2025. Alle Rechte vorbehalten.
              </div>
            </div>
          </div>

          {/* Mobile: Social Media and Copyright - Keep existing mobile sections */}
