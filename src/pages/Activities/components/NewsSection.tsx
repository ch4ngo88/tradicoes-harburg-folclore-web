...
const NewsSection = ({ newsItems }: NewsSectionProps) => {
  ...
  const swiperRef = useRef<any>(null) // <-- hier ist’s korrekt!
  ...
  return (
    <>
      ...
      <section className="mb-12 mt-8">
        ...
        <div className="mx-auto grid max-w-xl grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
...
<SwiperSlide key={item.label} className="flex justify-center items-center">
  <a
    href={item.href}
    target="_blank"
