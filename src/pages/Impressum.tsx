        ...
        <div className="glass-card p-8 space-y-8">
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-seagreen">Angaben gemäß § 5 TMG</h3>
            </div>
            <div className="pl-6 space-y-2">
              <p className="flex items-start gap-2">
                <span className="text-gray-700">Centro Português Harburg e.V.</span>
              </p>
              <p className="flex items-start gap-2">
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-seagreen">Vertreten durch</h3>
            </div>
          ...
          <section>
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-seagreen">Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</h3>
            </div>
            <p className="pl-6 text-gray-700">
